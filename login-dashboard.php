...
<html lang="en">
    <head>
        ...
        <!--Addition Stylesheet-->
        <link rel="stylesheet" type="text/css" href="css/dashboard-login.css">
        ...
        <div class="container m-0">
            <div class="forms-container">
                <div class="singin-singup">
                    <form action="_loginControl.php" class="sign-in-form" method="POST">
                        ...
                        <div class="input-field">
                            ...
                            <input type="email" placeholder="User Email" name="dash_log_u_email">
                        </div>
                        <div class="input-field">
                            <i class="fas fa-lock"></i>
                            <input type="password" placeholder="Password" name="dash_log_u_ps">
                        </div>
