        ...
        <div class="container">
            <div class="forms-container">
                <div class="singin-singup">
                    <form action="front-end/_loginControlFront.php" class="sign-in-form" method="POST">
...
<!--                        <p class="social-text">Or Sign-in with Social Media Platforms</p>
                    ...
                    <form action="_add-customer.php?status=addCustomer" class="sign-up-form" method="POST" enctype="multipart/form-data">
                        <h2 class="title">Sign Up</h2>
                        <div class="input-field">
                            <i class="fas fa-user"></i>
                            <input type="text" placeholder="User Name" name="c_uname">
                        </div>
                        <div class="input-field">
                            <i class="fas fa-envelope"></i>
