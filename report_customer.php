...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(277, 5, 'Customer Report (' . date('Y-m-d') . ')', 0, 1, 'C'); // Title
        $this->SetFont('Times', '', 13);
        $this->Cell(276, 10, 'Customer Details of SenzAgro (Pvt)Ltd.', 0, 0, 'C');
    ...
    function TableBody($conn) {
        ...
        while ($row = $stmt->fetch_assoc()) {
            $this->Cell(15, 10, $count_customer++, 1, 0, 'C', true);
            $this->Cell(60, 10, $row['customer_fname'] . ' ' . $row['customer_lname'], 1, 0, 'L', true);
            $this->Cell(35, 10, $row['customer_dob'], 1, 0, 'C', true);
            $this->Cell(30, 10, $row['customer_nic'], 1, 0, 'C', true);
            $this->Cell(25, 10, $row['customer_gender'], 1, 0, 'C', true);
            $this->Cell(50, 10, $row['customer_email'], 1, 0, 'C', true);
            $this->Cell(30, 10, $row['customer_cno1'], 1, 0, 'C', true);
            $this->Cell(35, 10, $row['customer_cno2'], 1, 1, 'C', true);
        }
    }
