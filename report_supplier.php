...
class PDF extends FPDF {
    ...
    function TableHeader() {
        ...
        $this->Cell(35, 10, 'Company', 1, 0, 'C', true);
        $this->Cell(60, 10, 'EMAIL', 1, 0, 'C', true);
        $this->Cell(50, 10, 'CONTACT NO', 1, 0, 'C', true);
        $this->Cell(50, 10, 'CONTACT NO', 1, 1, 'C', true);
    }
    ...
    function TableBody($conn) {
        ...
        while ($row = $stmt->fetch_assoc()) {
            $this->Cell(15, 10, $count_supplier++, 1, 0, 'C', true);
            $this->Cell(60, 10, $row['supplier_fname'] . ' ' . $row['supplier_lname'], 1, 0, 'L', true);
            $this->Cell(35, 10, $row['supplier_company'], 1, 0, 'C', true);
            $this->Cell(60, 10, $row['supplier_email'], 1, 0, 'C', true);
            $this->Cell(50, 10, $row['supplier_cno1'], 1, 0, 'C', true);
            $this->Cell(50, 10, $row['supplier_cno2'], 1, 1, 'C', true);
        }
    }
